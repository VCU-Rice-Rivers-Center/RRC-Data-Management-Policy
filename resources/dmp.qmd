...
If your research is funded through a grant, please use your funding agency's Data Management Plan requirements. 

This page provides additional guidance for the 5 sections found in the RRC DMP Template:
...
You can download the RRC DMP template [here](RRC_DataManagementPlanTemplate.docx).
...
* Which archive, repository, or database have you identified as a place to deposit data?
  * Check out the [RRC Data Repository Comparison Chart](https://vcu-rice-rivers-center.github.io/RRC-Data-Management-Policy/resources/repoChart.html) and
